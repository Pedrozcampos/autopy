...
class AuditProcessor:
    ...
    def aplicar_estilo(self, writer, nome_aba):
        ...
        objetivos_proc = {
            ...
            "ExcedeET": "Filtra lançamentos que possuem relevância financeira, acima da materialidade (Erro Tolerável) definida.",
            "Redondo": "Identifica lançamentos com valores redondos (possíveis estimativas).",
            "Sem Historico": "Detecta lançamentos com descrições ausentes ou curtas.",
            "Final De Semana": "Filtra lançamentos realizados em sábados ou domingos, o que pode sugerir lançamentos retroativos ou falta de controle de acesso ao sistema.",
            "Palavras Chave": "Busca termos sensíveis (ajuste, estorno, erro, etc) no histórico."
        }
                # -- linha 4 e 5 --
        ws['A4'] = "Objetivo:"
